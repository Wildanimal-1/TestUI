    ...
    <div>
      ...
      <div className="border border-[var(--border-primary)] mb-4">
        <div className="px-3 py-2 border-b border-[var(--border-primary)] bg-[var(--bg-secondary)]">
          <h2 className="text-[10px] font-medium text-[var(--text-tertiary)] uppercase tracking-wider">About this verification</h2>
        </div>
        <div className="px-3 py-3">
          <p className="text-xs text-[var(--text-secondary)] leading-relaxed">{config.description}</p>
        </div>
      </div>
      ...
      <div className="border border-[var(--border-primary)] mb-4">
        ...
        <div className="px-3 py-3 flex items-center justify-between">
          <div>
            <div className="text-xs text-[var(--text-secondary)] mb-1">Current status</div>
            <span className="inline-flex items-center gap-1 px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-wide bg-neutral-500/10 text-neutral-500 dark:text-neutral-400">
              <XCircle className="w-2.5 h-2.5" />
              Not verified
            </span>
          ...
          <div className="text-right">
            <div className="text-[10px] text-[var(--text-tertiary)] uppercase tracking-wider mb-1">Last attempt</div>
            <div className="text-xs font-mono text-[var(--text-secondary)]">—</div>
          </div>
        </div>
      </div>
