...
export default function AdminSystem() {
  ...
  return (
    <div>
      ...
      {/* State cluster: System Info + Registered Services */}
      <div className="grid grid-cols-12 gap-3 mb-6">
        <div className="col-span-5 border border-[var(--border-primary)]">
        ...
        <div className="col-span-7 border border-[var(--border-primary)]">
          ...
          <table className="w-full text-xs">
            <thead className="border-b border-[var(--border-primary)]">
              <tr>
                ...
                <th className="px-3 py-2 text-left font-medium text-[var(--text-tertiary)] uppercase tracking-wider w-20">Version</th>
                <th className="px-3 py-2 text-left font-medium text-[var(--text-tertiary)] uppercase tracking-wider w-20">Status</th>
                <th className="px-3 py-2 text-right font-medium text-[var(--text-tertiary)] uppercase tracking-wider w-20">Latency</th>
              </tr>
            </thead>
